  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.primaryColor,
        elevation: 0,
        title: const Text('BuyItNow',style: TextStyle(fontSize: 22,color: AppColors.textColor),),
        actions: [
          IconButton(onPressed: (){}, icon: const Icon(Icons.search),color: AppColors.textColor,),
        ],
      ),
                  ...
                  itemBuilder: (context,index){
                    return Card(
                      ...
                      alignment: Alignment.topCenter,
                          ...
                          Text(widget.items[index].name,style: const  TextStyle(
